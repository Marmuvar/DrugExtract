...
| --- | --- |
| pdf_read_product <br/> pdf_read_patent <br/> pdf_read_discnt | Parse Orange Book reports for individual sections | 
| modify_prod_csv | Clean field names and spacing in product files |
| thesis_filter_prods <br/> thesis_filter_dnc <br/> thesis_filter_pats | Consolidate and standardize entries from multiple volumes |
